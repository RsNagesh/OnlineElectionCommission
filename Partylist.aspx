<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Partylist.aspx.cs" Inherits="ElectionCommission.Partylist" %>
...
<asp:GridView ID="GrdVoting" runat="server" AutoGenerateColumns="False" Width="950px" ForeColor="#333333" GridLines="None">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="VoterId" HeaderText="Voter Id" SortExpression="ID" />
